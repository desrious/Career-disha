        ...
        <section className="mb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-10 rounded-[2.5rem] border border-outline-variant/10 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col h-full group">
              <div className="flex items-center gap-6 mb-8">
                ...
                <div>
                  ...
                  <p className="text-primary/80 font-medium text-xs leading-tight tracking-wide mt-1">Lead Career coach and Senior management consultant</p>
                </div>
              </div>
              ...
              <div className="flex gap-3 mt-8 pt-6 border-t border-outline-variant/10">
                <a href="mailto:gunjan.t@zeopto.com" className="px-6 py-2 bg-primary text-white rounded-full font-bold hover:bg-opacity-90 transition-colors">Email Us</a>
            ...
            <div className="bg-white p-10 rounded-[2.5rem] border border-outline-variant/10 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col h-full group">
              ...
              <div className="flex gap-3 mt-8 pt-6 border-t border-outline-variant/10">
                <a href="mailto:abhijit.v@zeopto.com" className="px-6 py-2 bg-yellow-500 text-white rounded-full font-bold hover:bg-opacity-90 transition-colors">Email Us</a>
